		...
		<div class="wrapcontent">
			...
			<div class="linha">
				<div class="coluna col12 formlogcad">
					...
					<div class="col6 left">
						<div class="col12">
							<p><b><font color="blue">Produto adicionado ao carrinho!!!</font></b></p>
						</div>
					</div>
				</div>

				<div class="coluna col6 formlogcad">

					<div class="col12 left">
						<div class="col12 logcad">
							<a href="./logado.php"><font style="text-align: center">Deseja continuar comprando!</font></a>
						</div>
					</div>
				</div>
				...
				<div class="coluna col6 formlogcad">
					...
					<div class="col12 left">
						<div class="col12 logcad">
							<a href="./shoplist.php">Deseja ir para o carrinho!</a>
						</div>
					</div>
				</div>
